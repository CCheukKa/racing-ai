...
const tickSpeedDisplay = document.getElementById('tickSpeed') as HTMLDivElement;
...
class Cars {
    ...
    public static deserialiseCarData(carData: SerialisedCarData): Car {
...
class NeuralNetwork {
    ...
    public static redraw() {
        const { layerSizes, layerCount, nodeRadius } = NeuralNetwork.redrawNeuralNetwork(this.getInputLayerSize(), this.hiddenLayerSizes);
