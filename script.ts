...
class LeaderBoard {
    ...
    private static updateCarPeekerContent(carData: SerialisedCarData, rank: number) {
        ...
        LeaderBoard.carPeeker.innerHTML = `Rank: ${rank}<br>Score: ${carData.score.toFixed(2)}<br>Lap: ${carData.lapCount.toFixed(2)}<br>Avg Speed: ${carData.averageSpeed.toFixed(4)}`;
    }
