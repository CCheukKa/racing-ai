...
export const TRANSLATIONS: Record<SupportedLanguage, TranslationBundle> = {
    ...
    "zh-HK": {
        ...
        staticText: {
            ...
            "#frontText": "前方 (0°)",
            "#backText": "後方",
            "label[for='probeAngles']": "探針°",
            ".neuralNetworkContainer .title": "輸入層",
            "label[for='probeDistances']": "探針距離",
            ...
            ".inputLayerContainer .layerLabel": "輸入",
            ".hiddenLayersContainer .layerLabel": "隱藏",
            ".outputLayerContainer .layerLabel": "輸出",
            "label[for='tickLimit']": "每代 Tick 上限",
            "label[for='populationSize']": "目標族群數量",
            ...
            ".naturalSelectionContainer .statusBoard .header div:nth-child(2)": "族群",
            ".naturalSelectionContainer .statusBoard .header div:nth-child(3)": "存活",
            ".naturalSelectionContainer .statusBoard .header div:nth-child(4)": "最佳分數",
            "#tickLoopButton": "開始",
            "#generationLoopButton": "本代後停止",
        ...
        staticTitle: {
            "label[for='probeDistances']": "每個探針到草地的距離",
            ...
            ".leaderboardContainer .leaderboardTableContainer .header div:nth-child(2)": "車輛名稱或雜湊值",
        ...
        prompts: {
            resetSettingsConfirm: "確定要重設所有設定嗎？這也會重新整理頁面。",
            ...
            leaderboardCarNamePrompt: "請輸入車輛名稱（可選）：",
